 ...
 * @author dell-xps
 */
public class GamePlayScreenController extends ControlledScreen implements Initializable {
    ...
    public static void playSound() throws InterruptedException {
        ...
        try {
            openAudionStream = new AudioStream(new FileInputStream("RollDice.wav"));
